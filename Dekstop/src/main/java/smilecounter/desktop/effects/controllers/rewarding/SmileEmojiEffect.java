...
public class SmileEmojiEffect extends Effect {
    private static final EffectsLoader EFFECT = EffectsLoader.SMILE_EMOJI;
    ...
    public SmileEmojiEffect(DetectedFace face) {
        super(face);
        frame = 0;
